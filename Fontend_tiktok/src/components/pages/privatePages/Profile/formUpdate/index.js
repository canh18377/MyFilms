    ...
    return (  
        ...
        <form>
            <div className={clsx(Styles.formGroup)}>
                ...
                <input type="file" accept="image/*" id="profilePhoto" onChange={convertPhoto} />
               {previewPhoto && <Avatar size={100}
                src={previewPhoto}
                 />}
            </div>
            ...
            <div className={clsx(Styles.formGroup)}>
                ...
                <input type="text" id="username"  placeholder="name" value={profileInfo.name} onChange={(e)=>{setProfileInfo({...profileInfo,name:e.target.value})}}/>
            ...
            <div className={clsx(Styles.formGroup)}>
                ...
                <input type="text" id="caption" placeholder="caption" value={profileInfo.caption}  onChange={(e)=>{setProfileInfo({...profileInfo,caption:e.target.value})}} />
            </div>
        </form>
    </Modal>
